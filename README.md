...
| 版本 | 文件 | 说明 |
|------|------|------|
| v1.2 | `TWOEAT12.ZIP` | 棋盘区域双缓冲，根治闪烁；新增亮绿模式 |
| v1.1 | `TWOEAT11.ZIP` | 持久化双缓冲；删除存档确认；悔棋逻辑修复 |
| v1.0 | `TWOEAT10.ZIP` | 首个正式版：AI 对战、存档、设置、快捷键 |
...
完整技术细节见 [技术设计文档](docs/走四子技术设计文档.md)。

---

## 🙏 致谢

- **乌班图（AI 助手）**：技术协作、Bug 分析、代码审查
